  ...
  if (kind === "text" && isMarkdownFilePath(path)) {
    ...
    return (
      <div
        ...
        className="conversation-gesture-host h-full w-full overflow-auto bg-[var(--oh-surface)] text-white custom-scrollbar-always [--oh-scroll-fade-from:var(--oh-surface)]"
      >
